...
const updateSchema = z.object({
  ...
  introText:            z.string().max(300).nullable().optional(),
  outroText:            z.string().max(300).nullable().optional(),
  introPhone:           z.string().max(60).nullable().optional(),
  introWhatsapp:        z.string().max(60).nullable().optional(),
  introWebsite:         z.string().max(200).nullable().optional(),
  productInfo:          z.string().max(1000).nullable().optional(),
  titleCardText:        z.string().max(200).nullable().optional(),
  titleCardSub:         z.string().max(200).nullable().optional(),
  outroCardText:        z.string().max(200).nullable().optional(),
